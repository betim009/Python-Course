...
label_valor_pedido = tkinter.Label(janela, text="Valor do pedido: {:.2f}".format(valor_total))
...
# Botão Confirmar
botao_confirmar = tkinter.Button(janela, text="Confirmar", command=calcular_valor)

# Botão Finalizar Pedido
botao_finalizar = tkinter.Button(janela, text="Finalizar Pedido", command=finalizar_pedido)
